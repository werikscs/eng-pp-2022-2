...
// organizes vector where even numbers are placed on odd positions and vice versa
void organizeVector(vector<int>& vector){
    for(int i = 0; i < vector.size(); i++){
        ...
        if(vector[i] % 2 == 0 && i % 2 == 0){
            ...
            // if they are even, loop through entire array from next position relative to 'i' position 
        ...
        if(vector[i] % 2 == 1 && i % 2 == 1){
            ...
            // if they are odd, loop through entire array from next position relative to 'i' position 
            for(int j = i+1; j < vector.size(); j++){
